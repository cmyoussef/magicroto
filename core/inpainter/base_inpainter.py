...
if __name__ == '__main__':
    ...
    # # davis-2017
    mDir = r'C:\Users\mellithy\magicRoto\MR_MagicRotoSelector'
    frame_path = glob.glob(os.path.join(mDir, 'source_MagicRotoSelector\*.png'))
    frame_path.sort()

    mask_path = glob.glob(os.path.join(mDir, "20231115\mask_0*.png"))
    mask_path.sort()

    save_path = os.path.join(mDir, "avengers_split")
    ...
    checkpoint = r'D:\track_anything_project\checkpoints/E2FGVI-HQ-CVPR22.pth'
    device = 'cuda:0'
    ...
    print(frames.shape, "*100")
    print(masks.shape, "*100")
    ...
    for ti, inpainted_frame in enumerate(inpainted_frames):
        ...
        frame.save(os.path.join(save_path, f'{ti + 1:05d}.jpg'))
